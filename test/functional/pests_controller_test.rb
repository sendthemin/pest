...
class PestsControllerTest < ActionController::TestCase
  ...
  test "should create pest" do
    assert_difference('Pest.count') do
      post :create, pest: { common_name: @pest.common_name, family: @pest.family, invertebrate: @pest.invertebrate, scientific_name: @pest.scientific_name }
    end
  ...
  test "should update pest" do
    put :update, id: @pest, pest: { common_name: @pest.common_name, family: @pest.family, invertebrate: @pest.invertebrate, scientific_name: @pest.scientific_name }
    assert_redirected_to pest_path(assigns(:pest))
  end
